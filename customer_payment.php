<!Doctype HTML>
	...
	<body>
		...
		?>
<?php
 $query=oci_parse($conn,"select * from payment");
...
<br>
	...
	<h3 style="color:aliceblue"><center>View All employee</center></h3>
	<form action="" method="post">
	<input type="text" name="payment_id" placeholder="Enter payment id"/>
	<input type="submit" name="search" value="serach"/>
    <!-- <h3 style="color:aliceblue"><center>View All employee</center></h3>
	<form action="" method="post">
	<input type="text" name="e_position" placeholder="Enter employee Position"/>
	<input type="submit" name="search" value="serach"/> -->
</form>
<table>
	  <tr>
...
<?php 
      ...
      if(isset($_POST['search']))
        ...
        $query=oci_parse($conn,"select * from payment where payment_id=$payment_id");
           
        }
    // if(isset($_POST['search']))
    //     {
    //       $e_position=$_POST['e_position'];
    //     // $query=oci_parse($conn,"select * from employee where e_position='$e_position')");
    //     $query=oci_parse($conn,"select * from employee where e_position='hhh'");
    //     echo 'bbbbbbbbbb!' ."<br>";
	...
	<tr>
		...
		<!-- <td><form action="delete_payment.php" method="post">

<input type="hidden" name="delete_id" value="<?php echo $row['payment_id']; ?>">
